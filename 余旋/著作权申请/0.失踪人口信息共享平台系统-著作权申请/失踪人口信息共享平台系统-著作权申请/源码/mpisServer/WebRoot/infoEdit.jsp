				...
				<table width="90%" cellspacing="0" cellpadding="0" align="center">
					...
					<tr align="left">
						...
						<td width="70%">
							...
							<input type="text" name="foodName" value="${map.food_name}" >
						</td>
					</tr>
					...
					<tr>
						...
						<td  width="70%">
							<input type="text" name="people" value="${map.food_price}">
						</td>
					</tr>
					<tr>
						<td  width="20%">
						...
						<td  width="70%">
							<input type="text" name="pphone" value="${map.food_discount_price}">
					...
					<tr>
						...
						<td  width="70%">
						 <textarea name="description" rows="8" cols="40">${map.food_description}</textarea>
						</td>
					</tr>	
				</table>
				<div class="list">
