...
public class InfoEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		InfoMgrDao objectMgrDao = new InfoMgrDao();
		...
		if(ServletFileUpload.isMultipartContent(req)) {
	           ...
	           while(iter != null && iter.hasNext()) {   
	               ...
	               if(item.isFormField()) {   
	                   ...
	                   if( item.getFieldName().equals("foodName") ){
	                	   object.info_name =  str  ;
	                   }else if( item.getFieldName().equals("description")   ){ 
	                	   object.info_description =  str  ;
	                   }else if( item.getFieldName().equals("people")   ){ 
	                	   object.info_people =  str  ;
	                   }else if( item.getFieldName().equals("pphone")   ){ 
	                	   object.info_pphone=  str  ;
	                   }else if( item.getFieldName().equals("flag")   ){ 
	                	   object.info_flag =  str  ;
	                   } 
	               }    
	               //文件域   
        	   ...
        	   object.info_pic =  fileName ;
	           objectMgrDao.save(object);
